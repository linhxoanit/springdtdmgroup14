<%-- 
    Document   : footer
    Created on : Apr 21, 2017, 2:07:51 PM
    Author     : DucLinh
--%>
...
<html>
	...
	background:url(resources/image/bgfooter_phong.png) repeat-x;
	width:1000px;
	height:110px;">
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">6,959</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">15,400</span></p>
</div>
